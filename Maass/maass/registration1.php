...
//		var MARST = document.MatriForm.MARITAL_STATUS.options[document.MatriForm.MARITAL_STATUS.selectedIndex].value;
		...
		document.MatriForm.CHILDLIVINGWITHME[1].disabled=true;									
		 ...
		 else if ( document.MatriForm.MARITAL_STATUS[1].checked || document.MatriForm.MARITAL_STATUS[2].checked  || document.MatriForm.MARITAL_STATUS[3].checked  || document.MatriForm.MARITAL_STATUS[4].checked || document.MatriForm.MARITAL_STATUS[5].checked)
		{
  ...
  for (var i = 0; i < MatriForm.txtName.value.length; i++) {
	...
	MatriForm.txtName.focus( );
  	return false;
		...
		if ( !MatriForm.MARITAL_STATUS[0].checked && !MatriForm.MARITAL_STATUS[1].checked && !MatriForm.MARITAL_STATUS[2].checked && !MatriForm.MARITAL_STATUS[3].checked && !MatriForm.MARITAL_STATUS[4].checked)
		{
...
<div align="center">
  ...
  <table width="780" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="BlueTborder">
    <!--DWLayoutTable-->
    <tr>
...
Awaiting divorce 
<input name=MARITAL_STATUS type=radio class="forminput" onClick="return HaveChildnp(this)" value=5>Any</div></TD>
                              </TR>
                              <TR>
                                <TD class=grebg colSpan=2><IMG height=1  src="pics/trans.gif"></TD>
                              </TR>
...
Not living with me </div></TD>
 ...
 -->                             
					...
					<TD><div align="left">
					  <input name="txtGothra" type="text" class="forminput" id="txtGothra" size="40" maxlength="40" style="width:215px;" onKeyUp="nospaces(this)">
					</div></TD>
					</TR>
					<!-- -->
