...
<div align="center">
<a class="thumbnail" href="viewprofile<?php echo $row['MatriID']?>.htm" target="_blank"> 
...
<? } ?>
  ...
  <td width="422" valign="top"><table width="100%" border="0" cellpadding="3" cellspacing="4">
    <tr>
	  ...
	  <a href="viewprofile<?php echo $row['MatriID']?>.htm" title="<?php echo $row['Caste']?> Matrimony - <?php echo $row['Subcaste']?> Matrimonial - <?php echo $info['Webname']; ?>" target="_blank" >
    ...
    <tr>
      ...
      <td><div align="left">
        <div align="left"><span class="smalltextgrey">
		  ...
		  echo "$newprofile\n";
		  ?>
        </span> <a href="viewprofile<?php echo $row['MatriID']?>.htm" target="_blank">More...</a> </div>
      </div></td>
    </tr>
  </table></td>
  </tr>
