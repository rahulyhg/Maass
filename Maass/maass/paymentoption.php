    ...
    <tr>
      <td valign="top" width="511"><table cellspacing="0" cellpadding="0" width="500" border="0">
        <tbody>
          ...
          <table 
            style="BORDER-RIGHT: #5f9ec9 1px solid; BORDER-TOP: #5f9ec9 1px solid; BORDER-LEFT: #5f9ec9 1px solid; WIDTH: 498px; BORDER-BOTTOM: #5f9ec9 1px solid" 
            ...
            <tbody>
              <tr>
				...
				<table 
                  style="BORDER-RIGHT: #F5F5F5 10px solid; BORDER-TOP: #F5F5F5 10px solid; BORDER-LEFT: #F5F5F5 10px solid; WIDTH: 520px; BORDER-BOTTOM: #F5F5F5 10px solid" 
                  cellspacing="0" cellpadding="0" bgcolor="#ffffff" border="0">
                    <tbody>
                      <tr>
                      <td valign="center" width="89" height="30">
                      					<div style="width: 165px; margin-right:10px;" class="inner-box fleft smalltxt">
						<div class="inner-box-top"><p><!--  --></p></div><div class="inner-box-body" style="height:104px;">
						<span class="boldtxt" style="FONT-SIZE: 11px; COLOR: #1670ae; FONT-FAMILY: verdana; font:bold;">Diamond Packages</span><br />3 Months<br />Unlimited profile<br />Unlimited horoscope<br/>Limited Contact no:30<br/>Amount:3000								
						<br clear="all" />
						</div>
                        </div>
                        </td>
                        <td valign="center" width="89" height="30">
                        <div style="width: 80px; margin-right:10px;" class="inner-box fleft smalltxt">
						<div class="inner-box-top"><p><!--  --></p></div><div class="inner-box-body" style="height:104px;">
						<br />6 Months<br />Unlimited profile<br />Unlimited horoscope<br/>Limited Contact no:65<br/>Amount:5000								
						<br clear="all" />
						</div>
                        </div>
                        </td>
                       <td valign="center" width="89" height="30">
                        <div style="width: 80px; margin-right:10px;" class="inner-box fleft smalltxt">
						<div class="inner-box-top"><p><!--  --></p></div><div class="inner-box-body" style="height:104px;">
						<br />9 Months<br />Unlimited profile<br />Unlimited horoscope<br/>Limited Contact no:110<br/>Amount:7000								
						<br clear="all" />
						</div>
                        </div>
                        </td>
                        ...
                        <div style="width: 80px; margin-right:10px;" class="inner-box fleft smalltxt">
						<div class="inner-box-top"><p><!--  --></p></div><div class="inner-box-body" style="height:104px;">
						<br />12 Months<br />Unlimited profile<br />Unlimited horoscope<br/>Limited Contact no:140<br/>Amount:9000								
						<br clear="all" />
						</div>
                        </div>
                        </td>
