...
<TD valign="top"><br>
      <table width="97%" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="37%" background="pics/heading_bg.gif"><div align="left">&nbsp;&nbsp;<span class="bodysg">Simple Search Criteria</span></div></td>
          <td width="63%">&nbsp;</td>
        </tr>
      </table>
    ...
    <td><table width="97%" border="0" align="center" cellpadding="5" cellspacing="4" id="content">
      ...
      <tr>
		...
		<table width="100%" border="0" cellpadding="3" cellspacing="3">
          ...
          <tr>
            <td width="22%"><div align="left">Gender</div></td>
...
years</div></td>
          ...
          <tr>
            ...
            <td><input name="ps" type="radio" class="forminput"  value="Doesn't matter" checked="checked" />
              Doesn't matter   
                <input name="ps" type="radio" class="forminput"  value="Normal" />
Normal  
<input name="ps" type="radio" class="forminput"  value="Physical Challenged" />
Physical Challenged 
</td>
          </tr>
<tr>
            <td height="20" colspan="2"><div align="left">Location</div></td>
          </tr>
          <tr>
            <td>Country</td>
            ...
            <td><div align="left">
              <select name="occu" class="forminput" id="occu" style="width:215px;">
               <option value="Any" selected="selected">Any</option>
                ...
                <option value="Avidam">Avidam</option>
...
<tr>
            <td height="20" colspan="2"><div align="left">Habits is a heading:</div></td>
          </tr>
          <tr>
            <td>Eating Habits</td>
            <td><input name="eh" type="radio" class="forminput"  value="All" checked="checked" />
              All   
                <input name="eh" type="radio" class="forminput"  value="Vegetarian" />
Vegetarian  
<input name="eh" type="radio" class="forminput"  value="Non Vegetarian" />
Non Vegetarian  
</td>
          </tr>
          <tr>
            <td>Drinking</td>
            <td><input name="dr" type="radio" class="forminput"  value="All" checked="checked" />
              All   
                <input name="dr" type="radio" class="forminput"  value="Non-Drinker" />
  Non-Drinker
<input name="dr" type="radio" class="forminput"  value="Light / Social drinker" />
Light / Social drinker 
<input name="dr" type="radio" class="forminput"  value="Regular drinker" />
Regular drinker 
          ...
          <tr>
            <td>Smoking</td>
            <td><input name="sm" type="radio" class="forminput"  value="All" checked="checked" />
              All   
                <input name="sm" type="radio" class="forminput"  value="Non-Drinker" />
  Non-smoker
<input name="sm" type="radio" class="forminput"  value="Light / Social drinker" />
Light / Social smoker 
<input name="sm" type="radio" class="forminput"  value="Regular drinker" />
Regular smoker 
          ...
          <tr>
            <td>Keywords</td>
            <td>Enter keywords within quotes and for more than one keyword use a comma separator between words.<textarea rows="4" cols="50"></textarea>
</td>
           </tr>
          <tr>
