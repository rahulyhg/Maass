...
$update1 = mysql_query("update register set LastLogin=Thislogin WHERE MatriID='".$_SESSION['username']."' OR ConfirmEmail = '".$_SESSION['username']."'");

$Insert1 = mysql_query("UPDATE register SET Thislogin = NOW() WHERE MatriID='".$_SESSION['username']."' OR ConfirmEmail = '".$_SESSION['username']."'");



$authent = mysql_query("SELECT * FROM register where MatriID='".$_SESSION['username']."' OR ConfirmEmail = '".$_SESSION['username']."'");
...
<TD valign="top"><br>
      <table width="97%" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="37%" background="pics/heading_bg.gif"><div align="left">&nbsp;&nbsp;<span class="bodysg">Profile Status </span></div></td>
          <td width="63%">&nbsp;</td>
        </tr>
      </table>
